...
class Statistics:
    ...
    def get_statistics(self):
        ...
        self.statisticsdict['stdev'] = [x for x in zip(stderivation_sorted.index,
        ...
        if len(three_point_df_n) > 0:
            self.statisticsdict['threePoints'] = [x for x in zip(three_point_df_sorted.index,
        ...
        self.statisticsdict['secondRound'] = [x for x in zip(second_round_sorted.index,
        ...
        self.statisticsdict['norm_guy'] = [x for x in zip(norm_guy_result_df.index,
